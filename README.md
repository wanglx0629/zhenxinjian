...
### 6.6 基础食物库
- 内置 200 条常见食物（F001–F200，《中国食物成分表》第 6 版，每 100g 可食部口径），10 大分类：谷薯杂豆·主食、畜禽肉及制品、蛋奶及制品、水产及制品、大豆及制品、蔬菜、菌藻、水果、坚果·种子、油脂·调味·饮品。数据字典见 `docsFile/projectFile/04-食物库数据字典.md`。
